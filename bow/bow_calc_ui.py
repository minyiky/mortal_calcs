...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.emalj = QtWidgets.QCheckBox(self.verticalLayoutWidget)
        self.emalj.setObjectName("emalj")
        self.gridMaterials.addWidget(self.emalj, 2, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.emalj.setText(_translate("MainWindow", "Emalj"))
